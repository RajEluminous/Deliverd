...
<title>Fleet - Driver Invite</title>
</head>
<body>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px;margin: auto; font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px;">
  <tbody>
    ...
    <tr>
      <td><h2 style="margin-top: 30px;margin-bottom: 0;"> A Fleet owner, {{ $user['fleet_name'] }} , would like to add you to their fleet.</h2></td>
    </tr>
	 <tr>
      <td><p>Please click the link below accept the request and join the new fleet.</p></td>
    </tr>
	<tr>
      <td><p style="line-height: 22px;text-align: center;"><b> <a href="{{ $user['link'] }}">Go to etYay and accept the request</a> </b></p></td>
    </tr>
	<tr>
      <td>&nbsp;</td>
    </tr>
