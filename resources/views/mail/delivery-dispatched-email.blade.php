...
<title>Delivery Disptched</title>
</head>
<body>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px;margin: auto; font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px;">
  <tbody>
    ...
    <tr>
      <td><h2 style="margin-top: 30px;margin-bottom: 0;text-align: center;"> Order # {{ $user['order_id'] }}</h2></td>
    </tr>
	 <tr>
      <td style="text-align: center;"><p>Has been received by our driver and is on it's way to your Client</p></td>
    </tr> 
	<tr>
      <td>&nbsp;</td>
    </tr>
